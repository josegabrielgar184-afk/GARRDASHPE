...
export const ZOMBIE_CHARACTERS: ZombieCharDef[] = [
  ...
  },
  {
    ...
    skill: '+20% Daño + Uniforme táctico',
    skillDesc: 'Soldado cachaco con uniforme táctico azul. 20% más de daño y 110 HP base.',
    speedMult: 1,
    shieldFirstHit: false,
    magnetMeds: false,
    scoreMult: 1,
  ...
  },
  {
    ...
    skill: '+25% Velocidad + Uniforme táctico',
    skillDesc: 'Soldada cachaca con uniforme táctico rosa. 25% más de velocidad y 105 HP base.',
    speedMult: 1.25,
    shieldFirstHit: false,
    magnetMeds: false,
    scoreMult: 1,
